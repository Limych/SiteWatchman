...
class SiteWatchman {
    ...
    {
        if (empty($root)) {
            $root = (defined('SW_ROOT') && ! empty(SW_ROOT) ? SW_ROOT : __DIR__);
        }
        ...
        $show_report = ! $stelth_mode && ! isset($_REQUEST['q']);
...
?>
	<div class="alert alert-info text-right clearfix mt-5 small" role="alert">
		Report generated by <a href="https://github.com/Limych/SiteWatchman">SiteWatchman</a> v.<?= self::VERSION?>.<br/>
		© 2017 Andrey Khrolenok
	</div>
</div>
